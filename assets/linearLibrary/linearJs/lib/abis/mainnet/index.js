...
import lVET from './lVET';
  ...
  export default {
    LinearFinance, LnAssetSystem, LnBuildBurnSystem, LnConfig, LnChainLinkPrices, LnDebtSystem, LnCollateralSystem, LnRewardLocker, lUSD, LnRewardSystem, lBTC, lETH, lLINK, lTRX, lDOT, lYFI, lBNB, lADA, lXLM, lXAU, lXAG, lEUR, lUNI, lJPY, lXLCI, lXBCI, lVET
  };
