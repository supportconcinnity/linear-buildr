      ...
      import abi from '../../lib/abis/moonbase/LnRewardSystem';
      ...
      this.setRewardLockerAddress = async (_rewardLockerAddress, txParams) => {
        txParams = txParams || {};
        return await this.contract.setRewardLockerAddress(_rewardLockerAddress, txParams);
      };
