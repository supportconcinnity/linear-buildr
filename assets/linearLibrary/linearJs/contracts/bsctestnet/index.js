...
import lDOGE from './lDOGE';
  ...
  export default {
    LinearFinance, LnAssetSystem, LnConfig, LnChainLinkPrices, LnBandProtocol, LnDebtSystem, LnCollateralSystem, LnBuildBurnSystem, LnRewardLocker, LnRewardSystem, lUSD, lBTC, lETH, lHB10, lLINK, lTRX, lDOT, lYFI, lBNB, lXAU, lXAG, lADA, lXLM, lXCI, lXRP, lCHF, lEUR, lJPY, lXCU, lUNI, lDOGE
  };
