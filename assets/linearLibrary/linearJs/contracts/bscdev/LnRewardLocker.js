...
function LnRewardLocker(contractSettings) {
  ...
  this.__LnRewardLocker_init = async (
    _linaTokenAddr,
    _accessCtrl,
    _admin,
    txParams
    ...
    txParams = txParams || {};
    return await this.contract.__LnRewardLocker_init(
      _linaTokenAddr,
      _accessCtrl,
      _admin,
      txParams
  ...
  this.migrateRewards = async (users, amounts, unlockTimes, txParams) => {
    txParams = txParams || {};
    return await this.contract.migrateRewards(
      users,
      amounts,
      unlockTimes,
      txParams
  ...
  this.moveReward = async (
    ...
    txParams = txParams || {};
    return await this.contract.moveReward(
      from,
      recipient,
      amount,
      rewardEntryIds,
  ...
  this.moveRewardProRata = async (
    ...
    txParams = txParams || {};
    return await this.contract.moveRewardProRata(
      from,
      recipient1,
      amount1,
      recipient2,
