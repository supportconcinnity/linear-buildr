...
function LnRewardSystem(contractSettings) {
  ...
  this.__LnRewardSystem_init = async (
    ...
    txParams = txParams || {};
    return await this.contract.__LnRewardSystem_init(
      _firstPeriodStartTime,
      _rewardSigner,
      _lusdAddress,
      _collateralSystemAddress,
  ...
  this.claimRewardFor = async (
    ...
    txParams = txParams || {};
    return await this.contract.claimRewardFor(
      periodId,
      recipient,
      stakingReward,
      feeReward,
