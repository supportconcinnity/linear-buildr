...
function LnOracleRouter(contractSettings) {
  ...
  this.addBandOracle = async (
    ...
    txParams = txParams || {};
    return await this.contract.addBandOracle(
      currencyKey,
      bandCurrencyKey,
      oracleAddress,
      removeExisting,
  ...
  this.addBandOracles = async (
    ...
    txParams = txParams || {};
    return await this.contract.addBandOracles(
      currencyKeys,
      bandCurrencyKeys,
      oracleAddresses,
      removeExisting,
  ...
  this.addChainlinkOracle = async (
    ...
    txParams = txParams || {};
    return await this.contract.addChainlinkOracle(
      currencyKey,
      oracleAddress,
      removeExisting,
      txParams
  ...
  this.addChainlinkOracles = async (
    currencyKeys,
    oracleAddresses,
    removeExisting,
    txParams
    ...
    txParams = txParams || {};
    return await this.contract.addChainlinkOracles(
      currencyKeys,
      oracleAddresses,
      removeExisting,
      txParams
  ...
  this.linearCurrencyKeysToBandCurrencyKeys = async (bytes32_1, txParams) => {
    txParams = txParams || {};
    return await this.contract.linearCurrencyKeysToBandCurrencyKeys(
      bytes32_1,
      txParams
    );
  };
  ...
  this.setStalePeriodOverride = async (
    currencyKey,
    newStalePeriod,
    txParams
  ) => {
    txParams = txParams || {};
    return await this.contract.setStalePeriodOverride(
      currencyKey,
      newStalePeriod,
      txParams
    );
