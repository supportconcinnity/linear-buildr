...
function LnLiquidation(contractSettings) {
  ...
  this.__LnLiquidation_init = async (
    _lnBuildBurnSystem,
    _lnCollateralSystem,
    _lnConfig,
    _lnDebtSystem,
    ...
    txParams = txParams || {};
    return await this.contract.__LnLiquidation_init(
      _lnBuildBurnSystem,
      _lnCollateralSystem,
      _lnConfig,
      _lnDebtSystem,
  ...
  this.getUndercollateralizationMarkMarker = async (user, txParams) => {
    txParams = txParams || {};
    return await this.contract.getUndercollateralizationMarkMarker(
      user,
      txParams
    );
  };
  ...
  this.getUndercollateralizationMarkTimestamp = async (user, txParams) => {
    txParams = txParams || {};
    return await this.contract.getUndercollateralizationMarkTimestamp(
      user,
      txParams
    );
  };
  ...
  this.isPositionMarkedAsUndercollateralized = async (user, txParams) => {
    txParams = txParams || {};
    return await this.contract.isPositionMarkedAsUndercollateralized(
      user,
      txParams
    );
  };

  this.liquidatePosition = async (
    user,
    lusdToBurn,
    rewardEntryIds,
    txParams
    ...
    txParams = txParams || {};
    return await this.contract.liquidatePosition(
      user,
      lusdToBurn,
      rewardEntryIds,
      txParams
  ...
  this.markPositionAsUndercollateralized = async (user, txParams) => {
    txParams = txParams || {};
    return await this.contract.markPositionAsUndercollateralized(
      user,
      txParams
    );
  };
