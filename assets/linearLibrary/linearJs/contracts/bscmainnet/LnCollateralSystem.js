...
function LnCollateralSystem(contractSettings) {
  ...
  this.UpdateTokenInfo = async (
    ...
    txParams = txParams || {};
    return await this.contract.UpdateTokenInfo(
      _currency,
      _tokenAddr,
      _minCollateral,
      _close,
  ...
  this.UpdateTokenInfos = async (
    ...
    txParams = txParams || {};
    return await this.contract.UpdateTokenInfos(
      _symbols,
      _tokenAddrs,
      _minCollateral,
      _closes,
  ...
  this.burnAndUnstake = async (
    ...
    txParams = txParams || {};
    return await this.contract.burnAndUnstake(
      burnAmount,
      unstakeCurrency,
      unstakeAmount,
      txParams
  ...
  this.burnAndUnstakeMax = async (burnAmount, unstakeCurrency, txParams) => {
    txParams = txParams || {};
    return await this.contract.burnAndUnstakeMax(
      burnAmount,
      unstakeCurrency,
      txParams
    );
  ...
  this.migrateCollateral = async (_currency, _users, _amounts, txParams) => {
    txParams = txParams || {};
    return await this.contract.migrateCollateral(
      _currency,
      _users,
      _amounts,
      txParams
  ...
  this.moveCollateral = async (
    ...
    txParams = txParams || {};
    return await this.contract.moveCollateral(
      fromUser,
      toUser,
      currency,
      amount,
  ...
  this.stakeAndBuild = async (
    ...
    txParams = txParams || {};
    return await this.contract.stakeAndBuild(
      stakeCurrency,
      stakeAmount,
      buildAmount,
      txParams
  ...
  this.stakeAndBuildMax = async (stakeCurrency, stakeAmount, txParams) => {
    txParams = txParams || {};
    return await this.contract.stakeAndBuildMax(
      stakeCurrency,
      stakeAmount,
      txParams
    );
  ...
  this.userCollateralData = async (address_1, bytes32_1, txParams) => {
    txParams = txParams || {};
    return await this.contract.userCollateralData(
      address_1,
      bytes32_1,
      txParams
    );
