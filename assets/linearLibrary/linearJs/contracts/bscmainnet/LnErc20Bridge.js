...
function LnErc20Bridge(contractSettings) {
  ...
  this.addChainSupportForToken = async (tokenKey, chainId, txParams) => {
    txParams = txParams || {};
    return await this.contract.addChainSupportForToken(
      tokenKey,
      chainId,
      txParams
    );
  ...
  this.addToken = async (tokenKey, tokenAddress, lockType, txParams) => {
    txParams = txParams || {};
    return await this.contract.addToken(
      tokenKey,
      tokenAddress,
      lockType,
      txParams
  ...
  this.dropChainSupportForToken = async (tokenKey, chainId, txParams) => {
    txParams = txParams || {};
    return await this.contract.dropChainSupportForToken(
      tokenKey,
      chainId,
      txParams
    );
  ...
  this.isTokenSupportedOnChain = async (tokenKey, chainId, txParams) => {
    txParams = txParams || {};
    return await this.contract.isTokenSupportedOnChain(
      tokenKey,
      chainId,
      txParams
    );
  ...
  this.tokenSupportedOnChain = async (bytes32_1, uint256_1, txParams) => {
    txParams = txParams || {};
    return await this.contract.tokenSupportedOnChain(
      bytes32_1,
      uint256_1,
      txParams
    );
  ...
  this.withdrawnDeposits = async (uint256_1, uint256_2, txParams) => {
    txParams = txParams || {};
    return await this.contract.withdrawnDeposits(
      uint256_1,
      uint256_2,
      txParams
    );
