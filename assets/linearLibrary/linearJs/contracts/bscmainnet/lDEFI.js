...
import abi from "../../lib/abis/bscmainnet/lDEFI";

function lDEFI(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList["lDEFI"],
    abi,
  ...
  this.__LnAssetUpgradeable_init = async (
    _key,
    _name,
    _symbol,
    _admin,
    ...
    txParams = txParams || {};
    return await this.contract.__LnAssetUpgradeable_init(
      _key,
      _name,
      _symbol,
      _admin,
