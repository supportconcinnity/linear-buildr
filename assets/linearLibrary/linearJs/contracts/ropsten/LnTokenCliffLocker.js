      ...
      import abi from '../../lib/abis/ropsten/LnTokenCliffLocker';
      ...
      this.lockData = async (address_1, txParams) => {
        txParams = txParams || {};
        return await this.contract.lockData(address_1, txParams);
      };
      ...
      this.avaible = async (_user, txParams) => {
        txParams = txParams || {};
        return await this.contract.avaible(_user, txParams);
      };
