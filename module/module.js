...
module.exports = function clientInitModule() {
  this.addPlugin(path.resolve(__dirname, "nuxt-client-init.plugin.client.js"));

  const pluginIndex = this.options.plugins.findIndex(({ src }) =>
    src.match(/.+nuxt-client-init\.plugin\.client\..+/)
  );
