  ...
  >
    <div class="statusIcon">
      <div class="icon">
        ...
        />
        <img v-if="status == 1" src="@/static/transferProgress/completed.svg" />
        <img v-if="status == 2" src="@/static/transferProgress/failed.svg" />
      </div>
    </div>
    <div class="text" v>
      <div class="title">
      ...
      <div class="description">
        ...
        <span class="view" @click="openBlockchainBrowser(hash, networkId)"
          >view</span
        >
      </div>
    </div>
  ...
  methods: {
    async onListen() {
      try {
        ...
        const status = await lnrJSConnector.utils.waitForTransaction(this.hash);
