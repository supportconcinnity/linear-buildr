                ...
                <div class="burnBox">
                    <div class="actionBody">
                        ...
                        <div class="actionDesc">
                            Burn ℓUSD to unlock your staked LINA
                        </div>
                        ...
                        >
                            ...
                            <div class="itemRight">
                                <div class="ratio">
                                    {{toNonExponential(burnData.ratio)}}
                                </div>
                            </div>
                            <div
                                class="itemErrMsg"
...
export default {
    ...
    data() {
        return {
            ...
            burnData: { unStake: null, amount: null, ratio: 750 }, //burn所需数据

            activeItemBtn: -1, //当前激活按钮 0 unstake max, 1 burn max
    ...
    computed: {
        ...
        //Disable burn button
        burnDisabled() {
            return _.lte(this.burnData.amount, 0) || this.cratioError;
        },

        cratioError() {
            if (_.lt(this.burnData.ratio, "750")) {
    ...
    methods: {
        ...
        clickUnstakeMax() {
            if (this.errors.unStakeMsg) {
                ...
                this.errors = {
                    unStakeMsg: "Error message goes here1",
        ...
        //点击 Burn Max
        clickBurnMax() {
            // this.burnData = { unStake: 28938.22, amount: 398.23, ratio: 4892 };
            this.burnData.amount = 398.23;
            this.changeAmount(this.burnData.amount);
        ...
        changeStake(val) {
            this.burnData.amount = this.testRate.amount * val;
            this.burnData.ratio = this.testRate.ratio / val;
        },

        changeAmount(val) {
            this.burnData.unStake = this.testRate.unStake * val;
            this.burnData.ratio = this.testRate.ratio / val;
        },
