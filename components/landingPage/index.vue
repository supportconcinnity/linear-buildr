<template>
    <div id="landingPage">
        ...
        <Modal v-model="qrcodeDisplay" :footer-hide="true" :closable="false" :transfer="false" :mask="true"
            :mask-closable="true" class="seeDetailsModal">
            <div class="walletConnect">
                <div class="walletConnectBox">
                    <div class="top">
                        <img class="button" src="@/static/close.svg" @click.stop="
                                qrcodeDisplay = false
                            " />
                    ...
                    <div class="boxCopy">
                        <div class="copyTitle">
                            ...
                            <Tooltip class="globalInfoStyle" :content="tooltipContent" offset="0 6" placement="bottom"
                                @on-popper-hide="resetTooltipContent">
                                <div class="copyBtn" :data-clipboard-text="WalletConnectUri"
                                    data-clipboard-action="copy" @click="copyYouCode">
                                    <img class="cooyIcon" src="@/static/copy.svg" />
                                </div>
                            </Tooltip>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="introductBox">
                ...
                <div class="mRect mobileShow" @click.stop="selectedWallet(SUPPORTED_WALLETS_MAP.METAMASK)">
            ...
            <div class="walletBox">
                <div class="box">
                    ...
                    ">
                        <img class="boxLogo" src="@/static/logo-wallet-wallet-connect.svg" />
                        <div class="wallet">
                            <div class="boxSub">Connect wallet via</div>
                            <div class="boxTitle">
                                WalletConnect
        ...
        mounted() {
            ...
            if (autoConnect) {
                if(walletType == SUPPORTED_WALLETS_MAP.METAMASK){
                    ...
                    this.selectedWallet(SUPPORTED_WALLETS_MAP.WALLET_CONNECT);
                }
            }
        },
        methods: {
            ...
            makeCode() {
                ...
                QRCode.toCanvas(canvas, this.WalletConnectUri, {
                    margin: 0,
                    height: 429,
                    width: 429,
                }, (error) => {
